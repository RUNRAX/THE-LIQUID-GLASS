...
for y in range(height - 1, -1, -1):
    for x in range(width):
        ...
        # Reduced power to 4 to spread refraction across the entire lens (towards center)
        # Increased multiplier to 350 for an even stronger total refraction effect
        edge_dist_x = -math.pow(dx, 4) * dx * 350.0
        edge_dist_y = -math.pow(dy, 4) * dy * 350.0
...
print("Refraction brought to center and intensified.")
