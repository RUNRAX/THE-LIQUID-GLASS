...
for y in range(height - 1, -1, -1):
    for x in range(width):
        ...
        # Extremely soft, gentle curve (power of 2) with a much lower multiplier (50.0)
        # This completely removes any "sharp" bending at the edges and makes it buttery smooth
        edge_dist_x = -math.pow(dx, 2) * dx * 50.0
        edge_dist_y = -math.pow(dy, 2) * dy * 50.0
